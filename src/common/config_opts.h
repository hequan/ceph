...
OPTION(mon_esd_allow_primary_affinity, OPT_BOOL, false)  // allow primary_affinity to be set in the osdmap
...
OPTION(osd_ec_debug, OPT_INT, 0)   //debug the ec rollback
